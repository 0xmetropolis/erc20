...
contract MetalAirdropFactory is Ownable, ERC721Holder {
    ...
    function _deploy(
        ...
        // mint the position and transfer
        (uint256 lpTokenId,,,) = nonfungiblePositionManager.mint({params: mintParams});

        // The caller will distribute the airdrop amount
    ...
    function deploy(
        ...
        (token, lpTokenId) =
            _deploy(_name, _symbol, _initialPricePerEth, _totalSupply, _poolSupply);
